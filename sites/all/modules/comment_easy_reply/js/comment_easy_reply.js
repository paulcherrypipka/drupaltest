...
(function ($) {
  Drupal.behaviors.comment_easy_reply = {
    attach: function (context, settings) {
      ...
      $('.comment-easy-reply-number-link-wrapper', context).once().each(function () {
        ...
        if (Drupal.settings.comment_easy_reply != 'undefined'
          ...
          link.click(function (e) {
            ...
            if (commentnumber != 'undefined' && commentnumber > 0 && ajax_reply_enabled) {
      ...
      $('.comment-easy-reply-referrer-link-wrapper', context).once().each(function () {
        $(this).find('.comment-easy-reply-number-link').each(function () {
          var commentnumber = Drupal.comment_easy_reply.get_number_from_class($(this), 'comment-easy-reply-linknum-');
          if (commentnumber != 'undefined'  && commentnumber > 0) {
      ...
      if (Drupal.settings.comment_easy_reply != 'undefined'
        && Drupal.settings.comment_easy_reply.user_can_reply) {
        $('.comment-reply', context).once().each(function () {
          var scrollto = false;
          var ajax_reply_enabled = false;
          if (Drupal.settings.comment_easy_reply.scrollform_enabled) {
            scrollto = true;
      ...
      if (Drupal.settings.comment_easy_reply != 'undefined'
        ...
        $('.comment .links .quote, .comment-easy-reply-views-quote-link', context).once().each(function () {
